...
The weights of the finetuned extension models can be found in the [sharepoint]([NO LINK](https://amsuni-my.sharepoint.com/:f:/g/personal/akis_lionis_student_uva_nl/ErDPxSn83VxEjO1IsKiYPSIBsvrZeGSQSTF5iySda_Fqnw?e=tlAfdb) and have to be downloaded in the `src/work_dirs`. If there is a problem with the folder, send an email to akis.lionis[at]student.uva.nl to request access to the folder.
